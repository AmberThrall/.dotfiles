...
-- Print screen
hl.bind(mainMod .. " + SHIFT + Print", hl.dsp.exec_cmd("~/bin/screenshot"))
hl.bind("Print", hl.dsp.exec_cmd("~/bin/screenshot cur"))
hl.bind(mainMod .. " + Print", hl.dsp.exec_cmd("~/bin/screenshot sel"))
